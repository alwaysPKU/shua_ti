...
def thumb(label_before, imglist,label,variance,output):
    picsize=150
    cur_width = 0
    cur_height= 20
    nth=0
    ...
    if kind&1:
        ...
        for cluster in worstClusters[:100]:
           # thumb(names[images[cluster]],V[cnt],os.path.join(tagdest,"1_"+str(cnt)+".jpg"))
            thumb(labels_before[images[cluster]],names[images[cluster]],cluster,V[cnt],os.path.join(tagdest,"1_"+str(cnt)+".jpg"))
            cnt+=1
...
if __name__ == "__main__":
    ...
    dic['labels_file_2'] = 'labels_0.68_npy'
    dic['labels_file_1'] = 'zhangwei_label_data/zhangwei_home/labels_0.7'
